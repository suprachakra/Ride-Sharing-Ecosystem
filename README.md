...
|----------------------|------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------|
| **Early Q0 – Mid Q0** | **Phase 0: Pre-Planning & Feasibility**        | - Conduct feasibility study (regulatory, tech, driver union constraints)<br>- Identify budget ceilings & resource availability<br>- Outline minimal param-based surge + seat-based discount for MVP (exclude advanced ML)<br>- Form a Steering Committee & finalize RACI matrix                                                                                  | - Early scoping of E-01 (Dynamic Pricing), E-05 (Compliance)                | - **Product** (strategy, scope)<br>- **Finance** (budget feasibility)<br>- **Compliance** (reg approvals)<br>- **Ops** (driver union input)<br>- **Engineering** (early tech feasibility) | - Existing legal constraints & potential zone-based regs<br>- Preliminary budget constraints                                                                                                                              | - **Goals**: Confirm MVP viability & scope<br>- **Success Metrics**: <br> Feasibility approved by all depts<br> No major compliance showstoppers<br>- All relevant roles in RACI matrix identified                                                                                                                                                                                         | 1) Feasibility report<br>2) Preliminary scope & cost analysis<br>3) Steering Committee charter & RACI matrix                                                                                                                                                                                                                             | - Weekly Steering Committee check-ins<br>- Cross-department sign-off meeting once feasibility docs are ready                                                                                                                                                                                                                                                                     | - **Risk**: Overly optimistic budget or major regulatory obstacles<br>- **Risk**: Vague roles leading to cross-team misalignment                                                                                                                                                                                                                                                     | - If budget < needed, reduce MVP scope or seek external funding<br>- If local regs too strict, plan phased approach or additional compliance lead time<br>- Formal sign-off of RACI matrix to clarify responsibilities                                                                                                                                                                           | - Clear, realistic MVP definition<br>- Formal governance structure with cross-team alignment                                                                                                                                                                                                                                                                                                   | - “Ask-Me-Anything” sessions with driver reps<br>- Online survey for initial user appetite                                                                                                                                                                                                                                                                     | - Past expansions showed big scope creep—**now** we keep MVP small<br>- Strong cross-functional alignment from the start helps avoid confusion later                                                                                                                                                                                                                             | **PI-0**: Initial Inception & Feasibility                                 |
| **Late Q0 – Early Q1**| **Phase 1: MVP Requirements & Baseline Arch** | - Finalize minimal features: param-based surge, seat-based discount, “Why fare?” breakdown (EN-only for now)<br>- Set up dev/test environments with containerized microservices<br>- Implement basic logging & monitoring<br>- Document compliance toggles for surge caps and 2–4 week fallback procedures                                                                 | - E-01 (Dynamic Pricing) <br>- E-02 (Transparency & UX) <br>- E-05 (Compliance)  | - **Product** (final MVP scope)<br>- **Engineering** (infrastructure setup)<br>- **QA** (test harness design)<br>- **Ops** (driver readiness planning)<br>- **Compliance** (surge cap rules)             | - Finance budget sign-off for cloud infra<br>- Legal & compliance constraints on city-level surge caps                                                                                                                                  | - **Goals**: Lock MVP scope & baseline architecture<br>- **Success Metrics**: <br> MVP feature freeze (no creeping)<br> Load test stable at 50% of target<br> Preliminary compliance doc signed off                                                                                                                                                                                   | 1) MVP requirements doc<br>2) Architecture & environment setup docs<br>3) Surge cap compliance toggles                                                                                                                                                                                                                                     | - Bi-weekly sprint reviews for MVP dev progress<br>- Mid-phase brand check: “Why fare?” UI concept with Branding & Marketing                                                                                                                                                                                                                                                         | - **Risk**: Feature creep blowing up dev timeline<br>- **Risk**: Infrastructure cost overruns or insufficient environment for QA                                                                                                                                                                                                                                                      | - Strict backlog gating & MVP freeze<br>- Start with small test environment & scale if needed<br>- If overhead >2%, revert certain environment expansions                                                                                                                                                                                                                          | - Defined MVP with stable environment<br>- Basic compliance toggles & logging in place<br>- Teams ready to start core dev                                                                                                                                                                                                                                                                     | - Townhall with a small set of driver leaders to show “Why fare?” concept<br>- Slack channel for early feedback on surge & discount visuals                                                                                                                                                                                                                  | - Learned from prior attempts that too many languages at launch can slow dev—**start with EN** & add localization gradually<br>- Early containerization prevents rework later                                                                                                                                                                                                        | **PI-1**: MVP Requirements & Baseline Foundation                          |
| **Mid Q1 – Late Q1** | **Phase 2: Development & Internal Testing**     | - Develop core param-based surge logic & seat-based discount<br>- Implement “Why fare?” UI with basic i18n structure (but EN in MVP)<br>- QA executes load tests at 100% expected MVP volume<br>- Validate compliance toggles under concurrency                                                                                                                   | - E-01 (Dynamic Pricing) <br>- E-02 (Transparency & UX)<br>- E-05 (Compliance)   | - **Engineering** (feature dev)<br>- **QA** (load testing, regression coverage)<br>- **Ops** (pilot training materials in parallel)<br>- **Compliance** (test surge cap toggles)            | - Completed baseline architecture from Phase 1<br>- Budget & time for thorough QA test cycles                                                                                                                       | - **Goals**: Ensure stable, tested features<br>- **Success Metrics**: <br> <1% critical defects in QA<br> Sub-2s response time under load<br> 80% test coverage on MVP flows                                                                                                                                                                                                  | 1) Staging environment with final MVP build<br>2) Test results (performance, regression, compliance toggles)                                                                                                                                                                                                                             | - Sprint demos to Steering Committee<br>- Daily triage on test findings<br>- Final sign-off from QA & Ops for readiness                                                                                                                                                                                                                                                              | - **Risk**: Performance degrade >2s<br>- **Risk**: Fallback toggles untested or broken under concurrency                                                                                                                                                                                                                                                                            | - Container autoscaling & caching<br>- Thorough concurrency tests on toggles; if fail, fix or remove toggles before pilot                                                                                                                                                                                                                                                          | - MVP features proven stable in a controlled environment<br>- QA coverage meets thresholds<br>- Confidence to move into real pilot                                                                                                                                                                                                                                                           | - Possibly an internal “driver app day” with a few pilot drivers invited to test in-house<br>- Real-time Slack feedback on new seat discount logic                                                                                                                                                                                                                       | - Learned from past big-bang releases that a robust test harness avoids fiascos on day 1<br>- Early toggles are vital for compliance fallback                                                                                                                                                                                                                                      | **PI-2**: Core Development & Internal Validation                           |
| **Early Q2**         | **Phase 3: Pilot Launch (Small Target Zone)**   | - Deploy MVP to 1–2 pilot districts<br>- Run driver training sessions (Ops-led)<br>- Launch basic marketing pilot with discount/referral<br>- Monitor real usage data, confusion calls, driver acceptance                                                                                                                | - E-01 (Dynamic Pricing)<br>- E-02 (Transparency & UX)<br>- E-03 (Driver Incentive) | - **Ops** (driver training, local ops oversight)<br>- **Marketing** (small GTM pilot)<br>- **Product** (pilot config)<br>- **Engineering** (live monitoring)             | - Pilot budget from Finance<br>- Approval from local authorities for test in limited zone                                                                                                                                     | - **Goals**: Real-world validation in small zone<br>- **Success Metrics**: <br> On-time≥85% in pilot<br><br> Confusion calls<5%<br><br> Driver acceptance≥60%                                                                                                                                                                                                      | 1) Pilot config doc & training materials<br>2) Real-time dashboards on usage, confusion calls<br>3) Marketing pilot plan                                                                                                                                                                                                             | - Weekly pilot check-ins with driver feedback forums<br>- Bi-weekly user interviews or surveys on discount usage                                                                                                                                                                                                                                                                  | - **Risk**: Driver confusion or pushback<br>- **Risk**: Low adoption if marketing too small                                                                                                                                                                                                                                                                                      | - On-site driver workshops & Q&A<br>- Adjust marketing budget or discount for that zone if usage <3% after 2 weeks                                                                                                                                                                                                                                                           | - Validated MVP with actual paying users<br>- Identified issues to fix before citywide rollout<br>- Gains real driver & user sentiments                                                                                                                                                                                                                                                       | - Field visits & small local meetups with pilot riders/drivers<br>- In-app chat group or community forum for immediate feedback                                                                                                                                                                                                                               | - Learned that seat discount might need clearer explanation to drivers in real usage<br>- Pilots help refine training approach                                                                                                                                                                                                                                              | **PI-3**: Real-World Pilot & Feedback                                     |
| **Mid Q2 – Late Q2** | **Phase 4: Measured Expansion & Enhanced Feats** | - Expand coverage to ~25–50% of city<br>- Continue driver training, larger marketing push<br>- Introduce advanced ML in **shadow mode** (no user-facing impact yet)<br>- Integrate local payment gateways or wallets (if feasible)                                                                                                                          | - E-01 (Dynamic Pricing) <br>- E-02 (Transparency) <br>- E-06 (Marketing & GTM) <br>- E-08 (Localization) | - **Engineering** (scaling, ML pipeline in shadow mode)<br>- **Data/Analytics** (ML performance tracking)<br>- **Ops** (new zone driver training)<br>- **Marketing** (broader campaign) | - Pilot success metrics from Phase 3<br>- Cloud infra readiness for scaling<br>- Budget for partial city rollout and marketing                                                                                              | - **Goals**: Smooth partial rollout + gather ML insights<br>- **Success Metrics**: <br> On-time≥90%<br> Driver acceptance≥70%<br> ML overhead <2% of budget in shadow mode<br>- Payment success≥98% if local gateways enabled                                                                                                                                                                | 1) Expansion plan doc<br>2) ML shadow-run dashboards<br>3) Payment gateway pilot integration (if relevant)                                                                                                                                                                                                                          | - Weekly expansion health checks (Ops, QA, Eng)<br>- Monthly ML performance review<br>- Marketing cost vs. new user acquisition checks                                                                                                                                                                                                                                         | - **Risk**: Performance degrade with 50% coverage<br>- **Risk**: ML pipeline cost overshadowing benefits<br>- **Risk**: Payment integration complexities if partial or local wallets                                                                                                                                                                                               | - Auto-scaling & caching<br>- Finance sets cost threshold for ML; if overhead >2%, revert or freeze advanced ML<br>- Progressive payment rollout in limited districts first                                                                                                                                                                                                 | - Achieved stable expansions & partial city coverage<br>- Gained early ML data in shadow mode<br>- Possibly offering local e-wallet options for bigger user base                                                                                                                                                                                                                             | - In-app marketing surveys for expanded zones<br>- Enhanced online driver community calls for newly covered districts                                                                                                                                                                                                                                     | - Learned from pilot that partial expansions (25–50%) avoid citywide meltdown<br>- Shadow-mode ML helps refine algorithm before a major flip                                                                                                                                                                                                                                  | **PI-4**: Expansion & ML Shadow Integration                                 |
| **Early Q3 – Mid Q3**| **Phase 5: Wider Rollout & ML Activation**       | - If ML results show >2–3% improvement, enable advanced ML surge logic (phased approach)<br>- Scale coverage to 75–100% city if prior phases stable<br>- Evaluate specialized fleets (van pooling or premium tiers) in small corridor                                                                                                                           | - E-01 (Dynamic Pricing) <br>- E-02 (Transparency) <br>- E-03 (Driver Incentive) <br>- E-08 (Scalability) | - **Engineering** (turn on ML, monitor performance)<br>- **Ops** (citywide driver training)<br>- **Compliance** (confirm local surge cap in advanced ML)<br>- **Marketing** (citywide)  | - Positive ML in shadow mode<br>- Stable pilot in 50% coverage<br>- Specialized fleet availability & brand alignment                                                                                                  | - **Goals**: Citywide coverage & advanced ML usage<br>- **Success Metrics**: <br> On-time≥95%<br> Driver acceptance≥80%<br> NPS≥4.5<br>- If specialized pilot is tested, usage≥3% to justify continuing                                                                                                                                                                                       | 1) Citywide coverage plan<br>2) ML activation instructions & dashboards<br>3) Specialized fleet pilot plan (if tested)                                                                                                                                                                                                               | - Bi-weekly coverage check<br>- Daily monitoring once ML is enabled<br>- Specialized pilot focus groups or surveys                                                                                                                                                                                                                                                            | - **Risk**: Brand negativity if ML drastically changes fares unpredictably<br>- **Risk**: Some districts might have untested local regs<br>- **Risk**: Specialized fleets demand bigger commissions                                                                                                                                                                          | - Gradual ML activation (district by district)<br>- Toggle off advanced ML in certain districts if local reg uncertain<br>- If specialized usage <3%, revert or keep niche pilot only                                                                                                                                                                                     | - Achieved near citywide coverage<br>- Advanced ML proven or partially adopted<br>- Potential new revenue streams from specialized fleets (if acceptance is good)                                                                                                                                                                                                                          | - City press events & driver community day<br>- In-app comms about “smarter surge” improvements                                                                                                                                                                                                                                         | - Learned from partial expansions how to handle leftover zones with stricter regs<br>- Observed driver acceptance of advanced ML improves if well-communicated                                                                                                                                                                                                               | **PI-5** & **PI-6**: Wider Rollout, ML Activation & Specialized Pilots        |
| **Late Q3 – Q4+**    | **Phase 6: Ongoing Maintenance & Multi-City**    | - Maintain 100% coverage citywide<br>- Monthly risk audits & compliance checks<br>- Quarterly ML model retrains & performance checks<br>- Plan expansions to new cities (feasibility, budgeting, local regs)                                                                                                                                         | - E-09 (Compliance & Risk Mgmt) <br>- E-06 (Marketing GTM for new territories) | - **Product** & **Strategy** (expansion decisions)<br>- **Finance** (budget for multi-city)<br>- **Compliance** (new city regulatory environment)<br>- **Engineering** (scaling) | - Stable citywide ops from Phase 5<br>- Additional capital if expansions are big<br>- Market research in target new cities                                                                                                                               | - **Goals**: Sustain success & consider multi-city<br>- **Success Metrics**: <br> NPS≥4.6 <br> Churn<5% <br> No major compliance issues<br>- Evaluate next city with a thorough feasibility study, with ROI≥X%                                                                                                                                                                     | 1) Monthly performance/risk reports<br>2) Model retrain logs<br>3) Next-city expansion proposals                                                                                                                                                                                                                                    | - Steering Committee monthly risk reviews<br>- Strategy board approvals for any new city expansions<br>- Continual Ops & driver feedback on new features                                                                                                                                                                                                                     | - **Risk**: ML drift over time, losing accuracy<br>- **Risk**: Underestimating local complexities for new city expansions<br>- **Risk**: Resource constraints (parallel expansions vs. stable ops)                                                                                                                                                                          | - Monitor drift & revert to param if needed<br>- Thorough feasibility & pilot approach for each new city<br>- Stage expansions or hire more staff if ROI is strong                                                                                                                                                                                                        | - Sustained citywide coverage with healthy adoption<br>- Clear path to replicate expansions in new geographies<br>- Ongoing compliance & brand trust                                                                                                                                                                                                                                         | - Citywide “user & driver appreciation day” <br>- Online polls on newly introduced features or changes                                                                                                                                                                                                                              | - Learned to keep regular risk audits to avoid complacency<br>- Only expand to new cities once local readiness and budget are aligned                                                                                                                                                                                                                                   | **PI-7+**: Maintenance & Multi-City Expansions                               |
